...
def get_ROC_RFE_(model,X, y, model_name, n_folds=5):
    ...
    plt.savefig(f'/Users/danielahernandez/Desktop/RFE OHNE PCA/roc_{model_name}.JPG')
...
def get_PR_rfe(model,X, y, model_name, n_folds=5):
    ...
    ax.legend(loc="lower right")
    plt.savefig(f'/Users/danielahernandez/Desktop/RFE OHNE PCA/pr_{model_name}.JPG')
    print(f'Done with {model_name}')
...
n_folds = 5
for model_name, model in models.items():
    get_PR_rfe(model,X, y, model_name, n_folds=n_folds)
