...
def get_ROC(model,X, y, model_name, n_folds=5):
    ...
    plt.savefig(f'/Users/danielahernandez/Desktop/MI/auc_{model_name}.JPG')
...
for model_name, model in models.items():
    get_ROC(model,X, y, model_name, n_folds=n_folds)
...
import warnings
warnings.filterwarnings('ignore')
def get_PR(model,X, y, model_name, n_folds=5):
    ...
    ax.legend(loc="lower right")
    plt.savefig(f'/Users/danielahernandez/Desktop/MI/pr_{model_name}.JPG')
    print(f'Done with {model_name}')
...
n_folds = 5
for model_name, model in models.items():
    get_PR(model,X, y, model_name, n_folds=n_folds)
