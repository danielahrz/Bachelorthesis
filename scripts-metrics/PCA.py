...
def get_ROC_pca(model,X, y, model_name, n_folds=1):
    ...
    plt.savefig(f'/Users/danielahernandez/Desktop/ROC_PCA/correct_roc_{model_name}.JPG')
...
def get_PR_PCA(model,X, y, model_name, n_folds=1):
    ...
    ax.legend(loc="lower right")
    plt.savefig(f'/Users/danielahernandez/Desktop/PCA-PR/schufllePR_{model_name}.JPG')
    print(f'Done with {model_name}')
