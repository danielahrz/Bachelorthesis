...
#Model evaluation applying Recursive Feature Elimination RFE
...
plt.savefig('/Users/danielahernandez/Desktop/RFE OHNE PCA/accu_rfe_pca_5000.JPG')
plt.show()
...
#Pipeline model evaluation for the five chosen classifiers - F1-scores
...
plt.xlabel('model', fontsize = 11) 
plt.savefig('/Users/danielahernandez/Desktop/RFE OHNE PCA/f1_rfe_pca_all.JPG')
plt.show()
...
def get_ROC_rec(model,X, y, model_name, n_folds=1):
    ...
    plt.savefig(f'/Users/danielahernandez/Desktop/RFE-NEW/correct_roc_{model_name}.JPG')
    print(f'Done with {model_name}')

models= {'KNeighborsClassifier':KNeighborsClassifier(n_neighbors=100),'LogisticRegression':LogisticRegression(penalty= 'l2'),'GaussianNB':GaussianNB(),'SVC':SVC(),'RandomForest': RandomForestClassifier()}



n_folds = 5
for model_name, model in models.items():
    get_ROC_rec(model,X, y, model_name, n_folds=n_folds)
...
def get_PR_REF(model,X, y, model_name, n_folds=1):
    ...
    ax.legend(loc="lower right")
    plt.savefig(f'/Users/danielahernandez/Desktop/RFE-NEW/REFPR_{model_name}.JPG')
    print(f'Done with {model_name}')
...
n_folds = 5
for model_name, model in models.items():
    get_PR_REF(model,X, y, model_name, n_folds=n_folds)
...
data1.to_csv('/Users/danielahernandez/Desktop/scores/2_RFE_scores.csv',index=False)
